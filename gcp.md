...
- [DevOps Bash tools for GCP, GKE, GCE etc](#REDACTED)
...
- [SSH Tunnelling Through a Bastion Host](#REDACTED)
- [Set up access to GKE - Google Kubernetes Engine](#REDACTED)
- [See all the details you can query for a VM](#REDACTED)
- [Get the IP Address of a specific VM](#REDACTED)
- [Get the names + IPs of all or a selection of VMs by regex name match](#REDACTED)
- [Get the IP of a random node in a cluster](#REDACTED)
- [Get the IP address of a Load Balancer](#REDACTED)
- [Get the IP of your Google FileStore NFS server](#REDACTED)
...
[Jenkins JCasC config per environment](https://github.com/HariSekhon/Kubernetes-configs/blob/REDACTED/jenkins/overlay/jcasc-cm.patch.yaml#L113)

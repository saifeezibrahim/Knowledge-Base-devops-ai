...
- [Java Licensing Problem in Docker](#REDACTED)
- [Details](#details)
  - [Ports](#ports)
...
<https://docs.docker.com/engine/reference/commandline/build/#REDACTED>
...
[Azure DevOps Pipeline](https://github.com/HariSekhon/Templates/blob/master/REDACTED.yml).
...
![Works on My Computer](images/REDACTED.webp)

### Says "Works on My Machine" One More Time

![Say "Works on My Machine" One More Time](images/REDACTED.jpeg)

### Using Docker

![Using Docker](images/REDACTED.png)

...
- [Using SDKman](#using-sdkman)
  - [Help](#help)
  - [Update list of SDKs available to install:](#REDACTED)
  - [List all products SDKman can install](#REDACTED)
  ...
  - [Switch to use another SDK Version](#REDACTED)
  - [List all the selected SDKs](#list-all-the-selected-sdks)
  - [List the Version of a Specific SDK](#REDACTED)
  - [Delete a version of Java JDK installed](#REDACTED)
  - [Clean up temp space](#clean-up-temp-space)
- [Auto switch to the correct SDK using `.sdkmanrc`](#REDACTED)
- [Troubleshooting](#troubleshooting)
  - [Internet Not Reachable despite being online](#REDACTED)
  - [Can't Find Java Version to Install That is Clearly There](#REDACTED)

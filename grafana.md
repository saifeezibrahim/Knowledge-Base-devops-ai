...
- [CLI](#cli)
- [API](#api)
- [Grafana Alerts vs Prometheus Alert Manager](#REDACTED)
- [Grafana AWS Cloudwatch Dashboards](#REDACTED)
...
[monitoringartist/REDACTED](https://github.com/monitoringartist/REDACTED)

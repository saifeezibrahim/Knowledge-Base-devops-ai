...
- [Usage](#usage)
  ...
  - [Create self-contained 'uber jar' with all dependencies included using Assembly plugin](#REDACTED)
  ...
  - [Compile the main sources in `src/main/scala` and `src/main/java`](#REDACTED)
  - [Compile and run all tests](#compile-and-run-all-tests)
  - [Install jar to local Ivy repository](#REDACTED)
  - [Install jar to local Maven repository](#REDACTED)
  - [Push jar to remote repo (if configured)](#REDACTED)
  - [Pull down dependencies to `lib_managed/`](#REDACTED)
  - [Add task](#add-task)
- [Eclipse](#eclipse)
  - [SBT <= 0.12](#sbt--012)
  - [SBT 0.13+](#sbt-013)

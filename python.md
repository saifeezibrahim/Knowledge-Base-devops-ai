...
- [Libraries](#libraries)
  ...
  - [Virtualization & Containerization](#REDACTED)
  - [Pub/Sub](#pubsub)
...
- [Troubleshooting](#troubleshooting)
  ...
  - [Alpine `ModuleNotFoundError: No module named 'pip._vendor.six.moves'`](#REDACTED)
  - [Small vs Big Integers - is vs ==](#small-vs-big-integers---is-vs-)
- [Meme](#meme)
  - [Programming Python](#programming-python)
  - [Porting Your Language to the JVM](#REDACTED)
  - [ChatGPT Python - What I Expected vs What I Got](#REDACTED)
  - [Imported Package Tariffs](#imported-package-tariffs)
  - [Friend Showing C++ Code](#friend-showing-c-code)
  - [Lines of Code vs Understanding Methods](#REDACTED)
...
![Programming Python](images/REDACTED.png)

### Porting Your Language to the JVM

I wish I had discovered [Groovy](groovy.md) before [Jython](#jython)...

![Porting Your Language to the JVM](images/REDACTED.png)

### ChatGPT Python - What I Expected vs What I Got

![ChatGPT Python - What I Expected vs What I Got](images/REDACTED.jpeg)
...
![Lines of Code vs Understanding Methods](images/REDACTED.jpeg)

...
- [Plugins](#plugins)
  ...
  - [Java / Groovy / Scala / Kotlin & JVM Tools](#REDACTED)
  - [Ruby](#ruby)
...
- [Troubleshooting](#troubleshooting)
  ...
  - [Markdown Images with Relative Paths Not Displaying in Preview](#REDACTED)
  - [External Tool - unexpected EOF while looking for matching `''](#REDACTED)
- [See Also](#see-also)
- [Meme](#meme)
...
You can use this command ([doc](https://www.jetbrains.com/help/idea/REDACTED.html#macos)) to install plugins quickly from the command line:
...
- Java/Groovy/Scala/Kotlin/Maven/SBT/Gradle - see [JVM section](#REDACTED) further down
...
- [Zero Width Characters locator](https://plugins.jetbrains.com/plugin/REDACTED) - find characters that could break your code
...
- [Markdown Navigator Enhanced](https://plugins.jetbrains.com/plugin/REDACTED/)
...
- [Google Cloud Code](https://plugins.jetbrains.com/plugin/REDACTED)
...
- [Pieces](https://plugins.jetbrains.com/plugin/REDACTED) - code snippets - you should be using libraries but unfortunately some languages have boilerplate for which library do not solve the repetition between programs. See also [HariSekhon/Templates](https://github.com/HariSekhon/Templates)
...
- [AWS ToolKit](https://plugins.jetbrains.com/plugin/11349-aws-toolkit) - Amazon CodeWhisperer integration
- [TabNine](https://plugins.jetbrains.com/plugin/REDACTED) - AI code suggestions, no free tier any more
- [Codota AI Autocomplete for Java and JavaScript](https://plugins.jetbrains.com/plugin/REDACTED)
...
- [Codiumate](https://plugins.jetbrains.com/plugin/REDACTED) - CodiumAI integration
...
- [Duckly Pair Programming](https://plugins.jetbrains.com/plugin/REDACTED)
...
Even using the `open` command trick reveals [this common error on Mac](mac.md#REDACTED).

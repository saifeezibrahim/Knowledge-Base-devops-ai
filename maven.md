...
- [Template](#template)
- [Real World Example `pom.xml` builds](#REDACTED)
- [Best practice for release version incrementing](#REDACTED)
...
- [Stop wasting time downloading newer Snapshots](#REDACTED)
- [Phases](#phases)
- [Help](#help)
...
from: <http://blog.cloudera.com/blog/2012/08/REDACTED/>

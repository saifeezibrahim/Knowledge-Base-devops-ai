...
- [Kubernetes Configs](#kubernetes-configs)
  - [JCasC - Jenkins Configuration as Code](#REDACTED)
  - [GCP - create Node Pool of Larger Nodes for Jenkins](#REDACTED)
  - [Default Admin User + Password](#default-admin-user--password)
  - [Reset the Jenkins admin password when using Kubernetes Helm Chart](#REDACTED)
...
- [Jenkins X](#jenkins-x)
- [Old Manual Configuration of Jenkins on Kubernetes](#REDACTED)
- [Increase Jenkins Server Disk Space on Kubernetes](#REDACTED)
- [Troubleshooting](#troubleshooting)
  - [Recovery if you deleted the PersistentVolumeClaim](#REDACTED)
...
[traditional reset](jenkins.md#REDACTED)
...
Workaround for broken helm init url in older version of helm bundled is [here](https://stackoverflow.com/questions/61954440/REDACTED).
...
[resizeable disk](https://github.com/HariSekhon/Kubernetes-configs/blob/master/jenkins/base/REDACTED.yaml)
configuration.
...
which requires
[Groovy Console Scripting](https://github.com/HariSekhon/DevOps-Bash-tools/blob/master/jenkins/REDACTED.groovy)
to fix it).
...
```text
REDACTED   30Gi       RWO            Retain           Bound    jenkins/jenkins-home-jenkins-0   gcp-standard-resizeable            2y161d
```
...
```text
persistentvolumeclaim/jenkins-home-jenkins-0   Lost     persistentvolume/REDACTED   0                         gcp-standard-resizeable   61s
```

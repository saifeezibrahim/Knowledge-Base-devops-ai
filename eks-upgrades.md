...
- [Pre-Requisite Checks](#pre-requisite-checks)
  - [Update Deprecated / Removed API objects](#REDACTED)
  - [Generic Kubernetes Upgrade Checks](#REDACTED)
  - [Enable Master logs to go to CloudWatch Logs](#REDACTED)
  - [Ensure at least 5 Free IPs Available](#REDACTED)
  - [Check the IAM role has assume role for your account](#REDACTED)
  - [Review EKS cluster insights for issues that may affect upgrade](#REDACTED)
  - [eksup](#eksup)
  - [AWS Resilience Hub (Optional)](#aws-resilience-hub-optional)
- [Upgrade](#upgrade)
  - [Upgrade Control Plane - Master Nodes](#REDACTED)
  - [Upgrade Add-Ons](#upgrade-add-ons)
  - [Upgrade Data Plane - Worker Nodes](#REDACTED)

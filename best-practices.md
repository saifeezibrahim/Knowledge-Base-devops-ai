...
- [High Availability and Multi-Datacenter](#REDACTED)
- [Use Version Control for Everything Textual - Code, Configs & Docs](#REDACTED)
- [Releases](#releases)
  - [No production releases on Friday afternoons or after 4pm any day](#REDACTED)
...
- [Principle: Time Amplification Effect](#REDACTED)
- [Principle: Keep It Simple](#principle-keep-it-simple)
- [Principle: Clever Code is Hard to Debug](#REDACTED)
- [Vendors](#vendors)
- [Avoid Vendor Lock In](#avoid-vendor-lock-in)
- [Minimize / Manage Technical Debt](#minimize--manage-technical-debt)
- [Technology Specific Best Practices](#REDACTED)
  - [Dates - always use ISO8601 Date Format](#REDACTED)
  - [Docker Best Practices](#docker-best-practices)
  - [Kubernetes - Production Ready Checklist](#REDACTED)
  - [GitHub Actions CI/CD Best Practices](#REDACTED)
- [Memes](#memes)
  ...
  - [Commercial Negotiations - Out Foxing Vendors](#REDACTED)
  - [The Mobile Developer](#the-mobile-developer)
  - [Ignoring Non-Critical Problems At Work](#REDACTED)
...
![Software Devs Production Bug](images/REDACTED.jpeg)
...
![Development Cycle Friday Evening Edition](images/REDACTED.jpg)

![Breaking Stuff on Friday Let the Intern Fix It](images/REDACTED.jpg)
...
See the [Kubernetes Production Ready Checklist](REDACTED.md) doc.
...
![Try until it works](images/REDACTED.jpg)

### Getting Good At Engineering

![Getting Good At Engineering](images/REDACTED.png)
...
![Debugging Someone Else's Code](images/REDACTED.jpeg)

### Commercial Negotiations - Out Foxing Vendors

![Commercial Negotiations Out Foxing Vendors](images/REDACTED.png)
...
![Ignoring Non-Critical Problems At Work](images/REDACTED.png)
...
![Blaming the User](images/REDACTED.png)

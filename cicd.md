...
- [Self-Hosted CI/CD](#self-hosted-cicd)
  ...
  - [Concourse](#concourse)
  - [GoCD](#gocd)
- [Hosted CI/CD by Git repo providers](#REDACTED)
...
- [Hosted CI/CD - Cloud](#hosted-cicd---cloud)
  ...
  - [Azure DevOps Pipelines](#azure-devops-pipelines)
- [Hosted CI/CD - Mobile Development](#REDACTED)
- [Hosted CI/CD - 3rd Party (all are legacy)](#REDACTED)
  - [CircleCI](#circleci)
  - [Travis CI](#travis-ci)
  - [BuildKite](#buildkite)
  - [AppVeyor](#appveyor)
...
- [Diagram - CI/CD Pipeline Explained](#REDACTED)
- [Only the Athenians exist... I mean... only Jenkins and GitHub Actions exist...](#REDACTED)
- [Memes](#memes)
  - [Best Practice vs Green Check Marks](#REDACTED)
...
- [HariSekhon/DevOps-Bash-tools `jenkins/`](https://github.com/HariSekhon/DevOps-Bash-tools#REDACTED) -
...
- [HariSekhon/DevOps-Bash-tools `cicd/`](https://github.com/HariSekhon/DevOps-Bash-tools#REDACTED) -
...
- [HariSekhon/DevOps-Bash-tools `github/`](https://github.com/HariSekhon/DevOps-Bash-tools#REDACTED) -
...
- [HariSekhon/DevOps-Bash-tools `gitlab/`](https://github.com/HariSekhon/DevOps-Bash-tools#REDACTED) -
...
- [HariSekhon/DevOps-Bash-tools `azure_devops/`](https://github.com/HariSekhon/DevOps-Bash-tools#REDACTED) -
...
- [Bitbucket Data Center](https://confluence.atlassian.com/bitbucketserver/REDACTED.html) is the on-premise installable version
...
- [HariSekhon/DevOps-Bash-tools `bitbucket/`](https://github.com/HariSekhon/DevOps-Bash-tools#REDACTED) -
...
- Legacy
- see details in [Hosted Repo Providers](#REDACTED) section above as it's closer to them as a legacy TFS rebranding than the above cloud-native integrated offerings
...
- [HariSekhon/DevOps-Bash-tools `circleci/`](https://github.com/HariSekhon/DevOps-Bash-tools#REDACTED) -
...
- [HariSekhon/DevOps-Bash-tools `buildkite/`](https://github.com/HariSekhon/DevOps-Bash-tools#REDACTED) -
...
- 1 parallel build :-/
- [Acquired](https://jfrog.com/blog/REDACTED/) by JFrog
- Decommissioned / Dead
...
![Best Practice vs Green Check Marks](images/REDACTED.jpeg)

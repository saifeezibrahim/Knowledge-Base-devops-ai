...
- [Pod Anti-Affinity](#pod-anti-affinity)
  ...
  - [Stable On-Demand vs Preemptible / Spot Instances](#REDACTED)
...
- [Applications](#applications)
  ...
  - [App Right-Sizing - Goldilocks & Vertical Pod Autoscaler](#REDACTED)
- [DNS - Automatic DNS Records for Apps](#REDACTED)
...
- [Governance, Security & Best Practices](#REDACTED)
- [Find Deprecated API objects to replace](#REDACTED)
- [Helm](#helm)
  - [Helm is not IaC idempotent by itself](#REDACTED)
  - [Quickly update any Helm Charts in a `kustomization.yaml` file](#REDACTED)
...
[Automatic Certificate Management](https://en.wikipedia.org/wiki/REDACTED)
...
- [REDACTED.sh](https://github.com/HariSekhon/DevOps-Bash-tools/blob/master/kubernetes/REDACTED.sh)

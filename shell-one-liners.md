...
- [System & Shell](#system--shell)
  ...
  - [Show your $PATH entries one per line](#REDACTED)
  - [Log all Commands in a Shell Session](#REDACTED)
  - [Create a Ram Disk](#create-a-ram-disk)
- [Processes](#processes)
  - [Find disowned processes owned by the init PID 1](#REDACTED)
- [Dates](#dates)
  - [Get Current Epoch](#get-current-epoch)
  - [Convert Epoch Seconds to Human Readable Date](#REDACTED)
- [Files & Strings](#files--strings)
  - [Generate ASCII Art](#generate-ascii-art)
  - [Number Lines](#number-lines)
  - [Copy to Both Clipboard and Stdout simultaneously](#REDACTED)
  - [Squeeze Out Multiple Blank Lines](#REDACTED)
  ...
  - [Base64 Secrets to avoid dodgy characters](#REDACTED)
  - [Find Lines in a File present in Other Files](#REDACTED)
- [Network](#network)
  ...
  - [Quickly Serve Local Files over HTTP](#REDACTED)
  - [Top for Network Processes](#top-for-network-processes)
- [Disk](#disk)
  - [Find Biggest Files Taking Up Space](#REDACTED)
- [Mac](#mac)
  - [Use GNU CoreUtils](#use-gnu-coreutils)
  - [Mask BSD Core Utils with GNU Core Utils](#REDACTED)

...
- [OpenSearch](#opensearch)
  - [OpenSearch Index State Management (ISM)](#REDACTED)
  - [OpenSearch Snapshot Management](#opensearch-snapshot-management)
- [Bulk Indexing from Hadoop MapReduce (Pig) - Performance](#REDACTED)
...
[this doc](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/REDACTED.html).

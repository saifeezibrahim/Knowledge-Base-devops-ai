...
- [Fastlane App Distribution to Firebase](#REDACTED)
- [Firebase CLI](#firebase-cli)
  - [Firebase Login](#firebase-login)
  - [Firebase Google Application Credentials](#REDACTED)
    - [AdminSDK](#adminsdk)
    - [Dedicated Role with Restricted Permissions](#REDACTED)
    - [Configure and test Google Application Credentials](#REDACTED)
  - [List Projects](#list-projects)
  - [Configure Default Project](#configure-default-project)
  - [List Apps](#list-apps)
  - [Firebase App Distribution Upload](#REDACTED)

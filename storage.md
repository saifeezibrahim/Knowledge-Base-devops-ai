...
- [RAID](#raid)
  ...
  - [RAID 1 - mirroring across 2 disks](#REDACTED)
  - [RAID 4 - striping with parity on a single spare disk](#REDACTED)
  - [RAID 5 - striping with distributed parity across N number of disks](#REDACTED)
  - [RAID 6 - striping with double distributed parity across N number of disks](#REDACTED)
  - [Nested RAID Levels](#nested-raid-levels)
  - [RAID 10 - RAID 0 striping over a collection of RAID 1 mirror arrays](#REDACTED)
  - [RAID 01 - RAID 1 mirroring across two RAID 0 striped arrays](#REDACTED)
  - [RAID 50 - RAID 0 striping on top of RAID 5 stripe arrays](#REDACTED)
...
<https://www.purestorage.com/knowledge/REDACTED.html>

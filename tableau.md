...
- [Troubleshooting](#troubleshooting)
  - [Disk Space](#disk-space)
    - [Logs](#logs)
  - [Unable to proceed because of an error from the data source / Unable to connect to the Tableau Data Extract Server ""](#REDACTED)
  - [Recover Server Admin with no remaining LDAP server admins](#REDACTED)
...
Backup written to '/var/opt/tableau/tableau_server/data/tabsvc/files/backups/REDACTED.tsbak' on the controller node.
```

### Restore Tableau Server

```shell
tsm maintenance restore -f "REDACTED.tsbak"  # --encrypt-password "$password"
```

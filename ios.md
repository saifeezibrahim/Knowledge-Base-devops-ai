...
- [Metadata](#metadata)
  - [Clean](#clean)
- [Build Destinations and Simulators](#REDACTED)
...
- [Download Alternate XCode Versions](#REDACTED)
  - [XCodes](#xcodes)
- [Apple 2FA](#apple-2fa)
  - [2FA - Device Base](#2fa---device-base)
  - [2FA - Security & Control](#2fa---security--control)
  - [2FA - Fallback - SMS or Phone Call](#REDACTED)
- [Troubleshooting](#troubleshooting)
  - [security: SecKeychainItemImport: Unknown format in import](#REDACTED)
  - [security: SecItemCopyMatching: The specified item could not be found in the keychain](#REDACTED)
  - [XCodeBuild / Fastlane building hanging with no output](#REDACTED)
...
2025-01-30 14:18:57.750 xcodebuild[47478:154973817] Writing error result bundle to /var/folders/30/kxjrq3fj5tqdhsvbj3p9m2fh0000gq/T/REDACTED.xcresult
...
{ platform:iOS, id:REDACTED:placeholder, name:Any iOS Device }
{ platform:iOS Simulator, id:REDACTED:placeholder, name:Any iOS Simulator Device }
{ platform:iOS Simulator, id:REDACTED, OS:17.5, name:iPad (10th generation) }
{ platform:iOS Simulator, id:REDACTED, OS:17.5, name:iPad (10th generation) }
{ platform:iOS Simulator, id:REDACTED, OS:17.5, name:iPad Air 11-inch (M2) }
{ platform:iOS Simulator, id:REDACTED, OS:17.5, name:iPad Air 11-inch (M2) }
{ platform:iOS Simulator, id:REDACTED, OS:17.5, name:iPad Air 13-inch (M2) }
{ platform:iOS Simulator, id:REDACTED, OS:17.5, name:iPad Air 13-inch (M2) }
{ platform:iOS Simulator, id:REDACTED, OS:17.5, name:iPad Pro 11-inch (M4) }
{ platform:iOS Simulator, id:REDACTED, OS:17.5, name:iPad Pro 11-inch (M4) }
{ platform:iOS Simulator, id:REDACTED, OS:17.5, name:iPad Pro 13-inch (M4) }
{ platform:iOS Simulator, id:REDACTED, OS:17.5, name:iPad Pro 13-inch (M4) }
{ platform:iOS Simulator, id:REDACTED, OS:17.5, name:iPad mini (6th generation) }
{ platform:iOS Simulator, id:REDACTED, OS:17.5, name:iPad mini (6th generation) }
{ platform:iOS Simulator, id:REDACTED, OS:17.5, name:iPhone 15 }
{ platform:iOS Simulator, id:REDACTED, OS:17.5, name:iPhone 15 }
{ platform:iOS Simulator, id:REDACTED, OS:17.5, name:iPhone 15 Plus }
{ platform:iOS Simulator, id:REDACTED, OS:17.5, name:iPhone 15 Plus }
{ platform:iOS Simulator, id:REDACTED, OS:17.5, name:iPhone 15 Pro }
{ platform:iOS Simulator, id:REDACTED, OS:17.5, name:iPhone 15 Pro }
{ platform:iOS Simulator, id:REDACTED, OS:17.5, name:iPhone 15 Pro Max }
{ platform:iOS Simulator, id:REDACTED, OS:17.5, name:iPhone 15 Pro Max }
{ platform:iOS Simulator, id:REDACTED, OS:17.5, name:iPhone SE (3rd generation) }
{ platform:iOS Simulator, id:REDACTED, OS:17.5, name:iPhone SE (3rd generation) }
...
IDEPackageSupportUseBuiltinSCM = YES
        ...
        Ineligible destinations for the "SIT" scheme:
                { platform:iOS, id:REDACTED:placeholder, name:Any iOS Device, error:iOS 17.5 is not installed. To use with Xcode, first download and install the platform }
```
...
See [GitHub Actions - Mac Runner Versions vs XCode Versions](github-actions.md#REDACTED).

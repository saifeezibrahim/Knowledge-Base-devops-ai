...
- [Self-Hosted Runner on Kubernetes](#REDACTED)
- [CLI Usage](#cli-usage)
  - [Create Namespace for use by Orbs or Executor Runners](#REDACTED)
...
+REDACTED+----------+----------------------+
| REDACTED | default  | 2021-12-13T19:02:48Z |
+REDACTED+----------+----------------------+
```

```shell
circleci runner token delete REDACTED
```

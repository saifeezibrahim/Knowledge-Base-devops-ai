...
Simple at the shallow end (see [Jenkins in Docker in one command](#REDACTED)).
...
- [Jenkinsfile - Scripted vs Declarative pipelines](#REDACTED)
  - [Declarative](#declarative)
  - [Scripted](#scripted)
  - [Jenkinsfile Snippet Generator](#jenkinsfile-snippet-generator)
- [Quick Jenkins in Docker and SysAdmin Scripts](#REDACTED)
...
- [Jenkins on Docker in one command](#REDACTED)
- [Jenkins Scaling](#jenkins-scaling)
  - [Jenkins Master](#jenkins-master)
  - [Jenkins Workers / Slaves](#jenkins-workers--slaves)
- [Jenkins Slaves on Bare Metal / VMs](#REDACTED)
...
- [Troubleshooting](#troubleshooting)
  - [Reset the Jenkins admin password](#REDACTED)
  - [Shell "process apparently never started in"](#REDACTED)
...
[HariSekhon/DevOps-Bash-tools](https://github.com/HariSekhon/DevOps-Bash-tools#REDACTED)
...
[HariSekhon/Kubernetes - jenkins/base/values.yaml](https://github.com/HariSekhon/Kubernetes-configs/blob/REDACTED/jenkins/base/values.yaml#L136)
...
[REDACTED.groovy](https://github.com/HariSekhon/Jenkins/blob/master/vars/REDACTED.groovy)
...
[REDACTED.sh](https://github.com/HariSekhon/DevOps-Bash-tools/blob/master/jenkins/REDACTED.sh)
...
```groovy
 org.codehaus.groovy.control.REDACTED: startup failed:
...
- If you find yourself locked out, follow [tradition password reset](jenkins.md#REDACTED) or [JCasC password reset](jenkins-on-kubernetes.md#REDACTED)
...
<https://www.slideshare.net/andrewbayer/REDACTED>

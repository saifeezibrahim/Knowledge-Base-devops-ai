...
- [WARNING: Battery Life](#warning-battery-life)
  - [Mac battery runs hotter during charging](#REDACTED)
  - [Do not let your Macbook Pro get hot it will destroy the battery!!](#REDACTED)
  - [Performance Falls through the floor on last 5-10% of battery life](#REDACTED)
- [Terminal](#terminal)
...
- [Sending Control-Alt-Delete to Windows through Remote Desktop](#REDACTED)
...
- [Commands](#commands)
  - [Spotlight - Search for or Open anything](#REDACTED)
  - [Open URL from Terminal output](#open-url-from-terminal-output)
  - [Open](#open)
    - [Open URL in the default web browser](#REDACTED)
    - [Open current directory in Finder](#REDACTED)
    - [Open image in the default app (usually Preview)](#REDACTED)
    - [Show the File in Finder](#show-the-file-in-finder)
    - [Check default Application for a given file type](#REDACTED)
    - [Change the default Application for a given file type](#REDACTED)
      - [Set VLC to open AVI files](#set-vlc-to-open-avi-files)
      - [Set Chrome to open SVG files](#set-chrome-to-open-svg-files)
    - [Open an Application from the command line](#REDACTED)
  - [Clipboard](#clipboard)
  - [System Information](#system-information)
  - [Screenshots](#screenshots)
    - [Set Screenshot Location](#set-screenshot-location)
    - [Screenshot the Whole Screen](#screenshot-the-whole-screen)
    - [Screenshot a Selection - Drag a Rectangle](#REDACTED)
  ...
  - [Wifi](#wifi)
    ...
    - [Get Current Wifi Network Password](#REDACTED)
    - [List all Configured Wifi Networks](#REDACTED)
  - [Say - text-to-speech](#say---text-to-speech)
  - [Finding Files - Spotlight Search and Index Management](#REDACTED)
  - [Power Management](#power-management)
    - [Show Power Management Settings](#show-power-management-settings)
    - [Show Power Status, Batteries & UPS](#REDACTED)
  ...
  - [Packages](#packages)
    ...
    - [Inspect Package Contents Before Installing](#REDACTED)
  ...
  - [Disk Management](#disk-management)
    ...
    - [Erase a disk before decommissioning it](#REDACTED)
...
- [Shazam Songs while using Headphones](#REDACTED)
- [Hammerspoon - System Event Handler](#REDACTED)
- [KeyChain Access](#keychain-access)
- [Binaries Debugging](#binaries-debugging)
- [Creating Bootable CDs & USBs from ISOs](#REDACTED)
  - [Other Options](#other-options)
    - [CLI](#cli)
- [Asahi Linux on Apple Silicon](#asahi-linux-on-apple-silicon)
- [XCode Mobile App Builds](#xcode-mobile-app-builds)
- [Time Machine](#time-machine)
  - [WARNING: Vendor Encrypted Drives Cannot Be Used to Restore Data in the macOS Recovery Mode](#REDACTED)
  - [Exclude Paths from Backups](#exclude-paths-from-backups)
    - [Add Path to Backup Exclusions](#add-path-to-backup-exclusions)
    - [Remove Path from Backup Exclusions](#REDACTED)
  - [Trigger Backup](#trigger-backup)
  - [List Backups](#list-backups)
  - [Restore a file from latest backup](#REDACTED)
  - [Find Unexpected Big Files Going in to the Current Backup](#REDACTED)
  - [Sharing a Time Machine disk with Data](#REDACTED)
- [External Disk Management](#external-disk-management)
  ...
  - [Manually Delete the `.Spotlight-V100` folder](#REDACTED)
  - [Delete Versioned Backups](#delete-versioned-backups)
  - [Restart `mds`, `mds_stores` and `revisiond`](#REDACTED)
  - [Verify Free Space](#verify-free-space)
- [Troubleshooting](#troubleshooting)
  - [Discrepancy Between `df` and `du`](#discrepancy-between-df-and-du)
  - [Spotlight Search failing to find App](#REDACTED)
  - [XCodeBuild error complaining XCode only has command line tools](#REDACTED)
  - [Various Applications Fail to Open](#REDACTED)
  - [Cannot Delete - No Space Left on Device](#REDACTED)
  - [Emergency Backup](#emergency-backup)
  - [Bootup Hangs on Black Screen after Full Data Disk](#REDACTED)
  - [Emergency File Backup from Recovery Mode](#REDACTED)
...
- [Memes](#memes)
  ...
  - [Using Hardware to Solve Problems](#REDACTED)
  - [So you can have 50G RAM of Chrome tabs](#REDACTED)
...
[Spotlight Search failing to find App](#REDACTED) in the Troubleshooting section.
...
[Part 1](http://www.theinstructional.com/guides/REDACTED) -
List, Verify, Repair, Rename, Erase volumes

[Part 2](https://www.theinstructional.com/guides/REDACTED) -
...
See the instructions on the [audio](audio.md#REDACTED) page.
...
As documented on this [Audio page section](https://github.com/HariSekhon/Knowledge-Base/blob/main/audio.md#REDACTED)
...
if you've hit a [bootup problem](#REDACTED) and need to work in recovery mode,
...
See the [Emergency File Backup from Recovery Mode](#REDACTED)
...
```text
/Volumes/.timemachine/REDACTED/1234-56-78-901234/2025-02-21-012346.backup/2025-02-21-012346.backup
```
...
```shell
1660 2025-12-08-224300.inprogress//Macintosh HD - Data/System/Library/AssetsV2/REDACTED
```
...
```text
/Volumes/.timemachine/REDACTED/2025-03-28-015336.backup/2025-03-28-015336.backup
```
...
![Activity Monitor not open any more](images/REDACTED.png)
...
```shell
$ open -a "Settings"
The application /System/Applications/System Settings.app cannot be opened for an unexpected reason, error=Error Domain=NSOSStatusErrorDomain Code=-600 "procNotFound: no eligible process with specified descriptor" UserInfo={_LSLine=388, _LSFunction=REDACTED}
```
...
The application /Applications/Microsoft Remote Desktop.app cannot be opened for an unexpected reason, error=Error Domain=NSOSStatusErrorDomain Code=-600 "procNotFound: no eligible process with specified descriptor" UserInfo={_LSLine=388, _LSFunction=REDACTED}
```
...
[mistake of using vendor encryption](#REDACTED)
...
If you've had to do an [Emergency File Backup from Recovery Mode](#REDACTED),
...
![Using Hardware to Solve Problems](images/REDACTED.png)
...
![Chrome Take All Resources](images/REDACTED.jpeg)

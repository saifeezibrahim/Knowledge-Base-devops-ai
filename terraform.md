...
- [Terraform Console](#terraform-console)
  - [Convert Terraform `jsonencode()` to literal JSON](#REDACTED)
    - [Handling Multi-line `jsonencode()`](#handling-multi-line-jsonencode)
    - [Handling Multi-line `jsonencode()` with multi-line terraform block that depends on newlines](#REDACTED)
- [hcl2json](#hcl2json)
...
- you'll miss minor details while trying to manually migrate the whole code base, eg.
  missing a small `aws_elasticache_cache` vs `REDACTED` resource will leave you

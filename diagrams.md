...
- [Real World Architecture Diagrams](#REDACTED)
- [Templates](#templates)
...
- [Diagram of Diagrams-as-Code Tools](#REDACTED)
...
- [MermaidJS](https://mermaid.js.org/) - excellent multi-format flexible diagram language with code rendering directly
  inside GitHub markdown (`README.md`) files 
...
[![Text-to-Diagram Comparison Playground](https://img.shields.io/badge/REDACTED?logo=pending&logoColor=white)](https://text-to-diagram.com/)
[![D2](https://img.shields.io/badge/D2-playground-4A6FF3?logo=pending&logoColor=white)](https://play.d2lang.com/)
[![MermaidJS](https://img.shields.io/badge/MermaidJS-Live%20Editor-FF3399.svg?logo=data:image/svg%2bxml;base64,REDACTED+REDACTEDZCI+REDACTEDREDACTEDREDACTEDOyI+REDACTEDREDACTEDREDACTEDREDACTEDREDACTEDREDACTEDREDACTED+Cjwvc3ZnPgo=)](https://mermaid.live/edit)
...
[![Readme Card](https://github-readme-stats.vercel.app/api/pin/?username=HariSekhon&repo=REDACTED&theme=ambient_gradient&description_lines_count=3)](https://github.com/HariSekhon/REDACTED)

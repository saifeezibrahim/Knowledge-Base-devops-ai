...
- [Networking](#networking)
  - [CNI - Container Network Interface](#REDACTED)
    - [Flannel](#flannel)
    - [Calico](#calico)
...
- [Autoscaling](#autoscaling)
  ...
  - [KEDA - Kubernetes Event-Driven Autoscaling](#REDACTED)
- [Tips](#tips)
  - [K9s](#k9s)
  - [Kubecolor](#kubecolor)
...
See [Jenkins-on-Kubernetes](jenkins-on-kubernetes.md#REDACTED) doc
...
challenge.acme.cert-manager.io/REDACTED   pending   jenkins.domain.co.uk   3h1m
```

...
- [Spotify](#spotify)
  - [Clear Local Spotify Desktop Cache](#REDACTED)
- [Shazam Songs while using Headphones on Mac](#REDACTED)
  - [Automatically Switch to Using Multi-Output Device when Connecting Headphones](#REDACTED)
- [MP3 metadata editing](#mp3-metadata-editing)
  - [Setting Author and Album metadata](#REDACTED)
  - [Setting Track Number metadata](#setting-track-number-metadata)
  - [Recursively Set Metadata](#recursively-set-metadata)
    - [Recursively Set Artist and Album](#REDACTED)
...
See the Mac page's [Hammerspoon - System Event Handler](mac.md#REDACTED) section for

...
- [Kubernetes Cert Manager + Cloudflare Integration](#REDACTED)
- [Kubernetes External DNS + Cloudflare Integration](#REDACTED)
...
[HariSekhon/Kubernetes-configs external-dns](https://github.com/HariSekhon/Kubernetes-configs/blob/REDACTED/external-dns/base/values.yaml#L159)

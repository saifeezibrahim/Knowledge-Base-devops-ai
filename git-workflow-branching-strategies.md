...
- [GitHub Flow with Jira ticket integration](#REDACTED)
- [Why you shouldn't use long-lived feature branches](#REDACTED)
- [The Evils of Rebasing](#the-evils-of-rebasing)
  - [Cautionary Tale from Experience](#cautionary-tale-from-experience)
  - [Rebase Requires Force Push Overwrites Which Can Lose Code Permanently](#REDACTED)
- [Squash Commits](#squash-commits)
  - [Squash Merges Require Force Deleting Branches](#REDACTED)
    - [Script to safely Delete Squash Merged Branches](#REDACTED)
  - [Squash & Merge - multiple email addresses on your GitHub account](#REDACTED)
...
<https://github.blog/engineering/infrastructure/REDACTED/>
...
```mermaid
%% https://mermaid.js.org/syntax/gitgraph.html#REDACTED
...
gitGraph
    ...
    checkout long-lived-branch
    merge REDACTED id: "merge fixes" type: HIGHLIGHT
...
![Gandalf Rebase Not the End of All Things](images/REDACTED.jpeg)

...
- [MMCs](#mmcs)
- [WinDirStat - Disk Space Analysis](#REDACTED)
- [Commands](#commands)
  - [Networking](#networking)
  - [List Volumes](#list-volumes)
  - [Get Free Disk Space on All Volumes](#REDACTED)
  - [Disk Check Analysis](#disk-check-analysis)
  - [Find the location of a binary in the %PATH%](#REDACTED)
  ...
  - [Open file from the command line using default application](#REDACTED)
- [WSL - Windows Subsystem for Linux](#REDACTED)
- [GitHub Repos](#github-repos)
- [Meme](#meme)
  - [Headquarters](#headquarters)
  - [Wizard Install Software](#wizard-install-software)
  - [Best Keyboard for Programming](#best-keyboard-for-programming)
  - [Windows Problems vs Linux Problems](#REDACTED)
  - [Linux Users Switching Back After 10 Minutes of Using Windows](#REDACTED)
...
![Windows display control panel disabled](images/REDACTED.png)
...
You'll need to strip off the leading `REDACTED_PRIVATE_KEY` in that file
before you use it.
...
![Windows Problems vs Linux Problems](images/REDACTED.jpeg)

### Linux Users Switching Back After 10 Minutes of Using Windows

![Linux Users Switching Back After 10 Minutes of Using Windows](images/REDACTED.jpeg)

...
- [Billing](#billing)
- [Runtime Environments - Serverless vs Local](#REDACTED)
- [Agents](#agents)
...
- [Connections - Sources and Destinations Integrations](#REDACTED)
  - [JDBC Connector Install](#jdbc-connector-install)
  - [Enable `JDBCV2` Connector on the Secure Agent Group](#REDACTED)
...
- [Troubleshooting](#troubleshooting)
  ...
  - [VM Restarts require Graceful Restart of the Secure Agent](#REDACTED)
  - [Secure agent's OI Data Collector stuck in "Starting Up" phase or Error](#REDACTED)
  - [Vertica ODBC Connector Error](#vertica-odbc-connector-error)
  - [Disk Space](#disk-space)
  - [Log Disk Space Cleanup](#log-disk-space-cleanup)
  - [Kubernetes version error `K8s_10152`](#REDACTED)
  - [Kubernetes - Capture Pod Logs & Stats](#REDACTED)
  - [Kubernetes - Capture Spark Driver JStack Thread Dump](#REDACTED)
    - [Manually](#manually)
- [Meme](#meme)
...
[Installing the Secure Agent on Linux](https://docs.informatica.com/integration-cloud/REDACTED/current-version/installation-guide/installing_secure_agents/REDACTED/REDACTED.html)

[Downloading and installing the Secure Agent](https://docs.informatica.com/cloud-common-services/administrator/h2l/REDACTED/REDACTED/REDACTED.html)
(includes token creation screenshots)

[VM minimum specs](https://docs.informatica.com/integration-cloud/data-ingestion-and-replication/current-version/REDACTED/REDACTED/REDACTED.html)
...
<https://knowledge.informatica.com/s/article/REDACTED>
...
See this
[KB article](https://knowledge.informatica.com/s/article/REDACTED?language=en_US) for screenshots.
...
<https://knowledge.informatica.com/s/article/REDACTED?language=en_US>

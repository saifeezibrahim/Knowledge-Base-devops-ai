...
- [Markdown Best Practices](#markdown-best-practices)
  ...
  - [Split Code Block Commands and Outputs to Separate Blocks](#REDACTED)
...
- [Link Team Support Numbers to WhatsApp Desktop](#REDACTED)
...
[GitHub Markdown Syntax Documentation](https://docs.github.com/en/get-started/writing-on-github/REDACTED/REDACTED)
...
(See also: [The Evils of Git Rebasing](https://medium.com/@harisekhon/REDACTED))
...
```shell
wget -nc https://raw.githubusercontent.com/simple-icons/simple-icons/REDACTED/icons/linkedin.svg
```
...
```shell
shields_embed_logo.sh https://raw.githubusercontent.com/simple-icons/simple-icons/REDACTED/icons/linkedin.svg
```

Either will result in an output like this:

```text
logo=data:image/svg%2bxml;base64,REDACTED+REDACTEDREDACTEDREDACTEDREDACTEDREDACTEDREDACTED
```

Now the default LinkedIn logo comes out dim like this:

[![My LinkedIn](https://img.shields.io/badge/LinkedIn%20Profile-HariSekhon-blue?logo=data:image/svg%2bxml;base64,REDACTED+REDACTEDREDACTEDREDACTEDREDACTEDREDACTEDREDACTED=&logoColor=white)](https://www.linkedin.com/in/HariSekhon/)
...
```markdown
[![My LinkedIn](https://img.shields.io/badge/LinkedIn%20Profile-HariSekhon-blue?logo=data:image/svg%2bxml;base64,REDACTED+REDACTEDREDACTEDREDACTEDREDACTEDREDACTEDREDACTED=)](https://www.linkedin.com/in/HariSekhon/)
```
Result:

![My LinkedIn](https://img.shields.io/badge/LinkedIn%20Profile-HariSekhon-blue?logo=data:image/svg%2bxml;base64,REDACTED+REDACTEDREDACTEDREDACTEDREDACTEDREDACTEDREDACTED=)
...
```shell
wget -nc https://raw.githubusercontent.com/simple-icons/simple-icons/REDACTED/icons/oracle.svg
```
...
```text
logo=data:image/svg%2bxml;base64,REDACTED+REDACTEDREDACTEDI2ZmZmZmZiIgLz48L3N2Zz4K
```

Put in `shields.io` badge to replace the icon:

```markdown
[![Oracle](https://img.shields.io/badge/SQL-Oracle-F80000?logo=data:image/svg%2bxml;base64,REDACTED+REDACTEDREDACTEDI2ZmZmZmZiIgLz48L3N2Zz4K&logoColor=white)](https://oracle.com/)
```
Result:
...
Install the [Chrome extension](https://chrome.google.com/webstore/detail/REDACTED) or Firefox

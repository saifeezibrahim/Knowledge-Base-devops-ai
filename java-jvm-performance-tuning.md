...
- [Read up on JVM Garbage Collection Basics First](#REDACTED)
- [Don't make the Java Heaps too big](#REDACTED)
- [Set `-Xmx` and `-Xms` to the same value](#REDACTED)
- [JVM RAM overhead space](#jvm-ram-overhead-space)
- [Garbage Collection algorithm](#garbage-collection-algorithm)
- [G1GC pause time goal is a hint only](#REDACTED)
- [Add Verbose GC logging so you can investigate and debug GC Pauses](#REDACTED)

...
- [Pre-Requisite Checks](#pre-requisite-checks)
  ...
  - [Ensure Worker Nodes are Already Running the Same Version](#REDACTED)
  - [Check for Deprecated API objects](#REDACTED)
    - [Pluto](#pluto)
    - [Kube-No-Trouble](#kube-no-trouble)
    - [Deprecated APIs Metrics](#deprecated-apis-metrics)
    - [Kubectl Convert](#kubectl-convert)
  - [Nova Outdated Helm Charts or Container Images](#REDACTED)
...
8:51PM INF version 0.7.3 (git sha REDACTED)
...
```shell
kubectl get --raw /metrics | grep REDACTED
```

```text
# HELP REDACTED [STABLE] Gauge of deprecated APIs that have been requested, broken out by API group, version, resource, subresource, and removed_release.
# TYPE REDACTED gauge
REDACTED{group="",removed_release="",resource="componentstatuses",subresource="",version="v1"} 1
REDACTED{group="policy",removed_release="1.25",resource="poddisruptionbudgets",subresource="",version="v1beta1"} 1
REDACTED{group="policy",removed_release="1.25",resource="podsecuritypolicies",subresource="",version="v1beta1"} 1
REDACTED{group="storage.k8s.io",removed_release="1.27",resource="csistoragecapacities",subresource="",version="v1beta1"} 1
```
...
<https://kubernetes.io/blog/2021/04/06/REDACTED/>
...
<https://aws.amazon.com/blogs/containers/REDACTED/>
...
[:octocat: aws-containers/REDACTED](https://github.com/aws-containers/REDACTED)
...
[REDACTED](https://github.com/aws-containers/REDACTED):
...
```shell
REDACTED.sh kubernetes/autoscaler 1.28
```
...
```shell
REDACTED.sh kubernetes/autoscaler chart
```
...
![K8s Upgrades Unresponsive Pods](images/REDACTED.jpeg)

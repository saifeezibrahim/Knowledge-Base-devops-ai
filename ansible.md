...
- [Troubleshooting](#troubleshooting)
  ...
  - [Broken Ansible installations](#broken-ansible-installations)
    - [Quick workaround, just install a user local version](#REDACTED)
    - [ModuleNotFoundError: No module named 'ansible'](#REDACTED)
    - [[Errno 13] Permission denied: '/usr/lib/python2.7/site-packages/...'](#REDACTED)

...
- [Download Videos](#download-videos)
  ...
  - [Download Video Not Inferred from Web Page](#REDACTED)
  - [Download All Videos from YouTube Channel](#REDACTED)
  - [Stacher7 - GUI for yt-dlp](#stacher7---gui-for-yt-dlp)
- [Inspect Video File Metadata](#inspect-video-file-metadata)
  - [Get the resolution and other details like codec for a video file](#REDACTED)
- [Downscale Video to 720p mp4](#downscale-video-to-720p-mp4)
- [Clip Video](#clip-video)
  - [Clip Video Interactively using QuickTime Player](#REDACTED)
  - [Clip Video on Command Line using `ffmpeg`](#REDACTED)
- [Transcode mkv into standard mp4 for smart TVs to play](#REDACTED)

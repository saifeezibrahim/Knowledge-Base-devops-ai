...
- [Open an image file from the command line](#REDACTED)
- [Check & Change the default Application for a given file type](#REDACTED)
- [Convert Webp to PNG format](#convert-webp-to-png-format)
- [Convert SVG to PNG format](#convert-svg-to-png-format)
- [Trim Pixels off one side of an Image](#REDACTED)
- [Join Two Images Together](#join-two-images-together)
- [Create Animated GIFs of Terminal Commands](#REDACTED)

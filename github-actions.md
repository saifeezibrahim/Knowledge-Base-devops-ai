...
- [Mac Runner Versions vs XCode versions](#REDACTED)
- [GitHub Actions Master Template & Reusable Workflows](#REDACTED)
...
- [GitHub Actions Best Practices](#github-actions-best-practices)
  - [Security Hardening for GitHub Actions](#REDACTED)
  - [Pin 3rd party GitHub Actions to Git Hashrefs, not tags](#REDACTED)
  - [Avoid `${{ inputs }}` Shell Injection](#avoid--inputs--shell-injection)
  - [Validate all `${{ inputs }}`](#validate-all--inputs-)
  - [Enforce Shell Error Detection for entire Workflow](#REDACTED)
  - [Always Quote all Variables in Shell](#REDACTED)
  - [Serialize Workflows with Steps sensitive to Race Conditions](#REDACTED)
  - [Serialize all workflows that commit to the same Git repo](#REDACTED)
  - [Avoid Race Condition - Do Not Tag from Moving Targets eg. `master` or `latest`](#REDACTED)
  - [Do Not Write Legacy Technical Debt Code](#REDACTED)
    - [No More `save-state` or `set-output` commands](#REDACTED)
  - [Deduplicate Code Using Environment Variables grouped in top-level `env` section](#REDACTED)
  - [Begin Workflow Jobs with an Environment Printing Step](#REDACTED)
  - [Avoid putting Sensitive information such as Secrets in Global Environment Variables](#REDACTED)
  - [Look up GitHub Actions Contexts Fields and Environment Variables](#REDACTED)
  - [Sparse Checkouts](#sparse-checkouts)
  - [Import Reusable Workflows using Tags](#REDACTED)
- [Reusable Workflow Updates Lifecycle](#REDACTED)
  - [Trunk-based changes automatically inherited by calling workflows](#REDACTED)
  - [GitHub Tagged workflows imported by calling workflows](#REDACTED)
- [GitHub Actions vs Jenkins](#github-actions-vs-jenkins)
- [Diagrams](#diagrams)
  - [GitHub Actions CI/CD to auto-(re)generate diagrams from code changes (Python)](#REDACTED)
  - [GitHub Actions CI/CD to auto-(re)generate diagrams from code changes (D2lang)](#REDACTED)
- [Troubleshooting](#troubleshooting)
  - [Workflow hangs indefinitely - Waiting for a runner to pick up this job...](#REDACTED)
  - [Executable `/opt/hostedtoolcache/...` not found](#REDACTED)
...
[OIDC Overview](https://docs.github.com/en/actions/security-for-github-actions/REDACTED/REDACTED)
...
[Configure OIDC to AWS](https://docs.github.com/en/actions/security-for-github-actions/REDACTED/REDACTED)

[Configure OIDC to Azure](https://docs.github.com/en/actions/security-for-github-actions/REDACTED/REDACTED)

[Configure OIDC to Google Cloud](https://docs.github.com/en/actions/security-for-github-actions/REDACTED/REDACTED)

[Configure OIDC to HashiCorp Vault](https://docs.github.com/en/actions/security-for-github-actions/REDACTED/REDACTED)
...
[GitHub Actions OIDC thumbprints](https://github.blog/changelog/REDACTED/):
...
aws iam create-open-id-connect-provider \
          ...
          #--thumbprint-list REDACTED,REDACTED
```

[AWS IAM UserGuide OIDC Verify Thumbprint](https://docs.aws.amazon.com/IAM/latest/UserGuide/REDACTED.html)
...
<https://docs.github.com/en/actions/security-for-github-actions/security-guides/REDACTED>
...
<https://github.blog/changelog/REDACTED/>
...
See the [Reusable Workflow Updates Lifecycle](#REDACTED) section for more details.
...
Open [Diagrams-as-Code README.md](https://github.com/HariSekhon/Diagrams-as-Code/blob/master/README.md#REDACTED) to enlarge:

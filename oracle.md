...
- [Install Oracle Client Packages - SQL*Plus, JDBC, ODBC, SDK](#REDACTED)
  - [SQL*Plus Readline Support](#sqlplus-readline-support)
- [Local Login as Admin](#local-login-as-admin)
- [Connecting to Oracle - TNS Listener & SID](#REDACTED)
...
- [SQL](#sql)
  ...
  - [Show your Currently Connected Username](#REDACTED)
  - [Show Tables Owned by Currently Connected User](#REDACTED)
  - [Show the Privileges of the Currently Connected User](#REDACTED)
  ...
  - [Show DB Configuration Parameters](#REDACTED)
  - [Get Table DDL](#get-table-ddl)
  - [Investigate table](#investigate-table)
  - [Backup Table to adjacent backup table](#REDACTED)
- [Space Clean Up](#space-clean-up)
  ...
  - [Investigate Big Tables with Free Space](#REDACTED)
...
- [Restore table from adjacent backup table](#REDACTED)
- [Troubleshooting](#troubleshooting)
  - [Oracle Client Install `Error: Invalid version flag: or`](#REDACTED)
  - [SQLcl Error: Could not find or load main class oracle.dbtools.raptor.scriptrunner.cmdline.SqlCli](#REDACTED)
...
See [Oracle Client Install Error](#REDACTED)
...
**First [backup the table](#REDACTED)** you are going to shrink to an adjacent backup table.
...
Rollback if any problem following [Restore table from adjacent backup table](#REDACTED).
...
[HariSekhon/SQL-scripts - REDACTED.sql](https://github.com/HariSekhon/SQL-scripts/blob/master/REDACTED.sql)
